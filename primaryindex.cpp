...
class variable
{
    struct student
    {
        char usn[11],name[15],sem[10],dept[5];
    };
public:
    void add();
    void search1();
...
{
    ofstream out1,out2;
    out1.open("index10.txt",ios::in|ios::trunc);
    out2.open("student10.txt",ios::in|ios::trunc);
    out1.close();
    out2.close();
}
void variable::add()
{
    char buffer[100],temp[50],usn[11],usn1[11],temp1[50];
    int pos1,flag=0;
    student s;
    ifstream out2;
    out2.open("index10.txt",ios::in);
    ...
    {
        ofstream out1,out2;
        out1.open("student10.txt",ios::app);
        out2.open("index10.txt",ios::app);
...
void variable::search1()
{
    ...
    while(!out2.eof())
    {
        ...
        {
            out1.open("student10.txt",ios::out);
...
void variable::delete1()
{
    ...
    int pos,flag=0;
    student s;
    cout<<"\nEnter usn to be deletd:";
    cin>>usn;
    ifstream in1,in2;
    ofstream of1,of2;
    in1.open("index10.txt",ios::in);
    in2.open("student10.txt",ios::in);
    of1.open("index12.txt",ios::out);
    of2.open("student12.txt",ios::out);
    while(1)
    {
        in1.getline(temp,50,'$s');
        if(in1.eof())
            break;
    ...
    of2.close();
    remove("index10.txt");
    remove("student10.txt");
    rename("index12.txt","index10.txt");
    rename("student12.txt","student10.txt");
}
int main()
{
    int ch;
